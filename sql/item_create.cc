...
class Create_func_protobuf_update_repeated : public Create_native_func
{
public:
  virtual Item *create_native(THD *thd, LEX_STRING name,
                              PT_item_list *item_list);

  static Create_func_protobuf_update_repeated s_singleton;

protected:
  Create_func_protobuf_update_repeated() {}
  virtual ~Create_func_protobuf_update_repeated() {}
};
...
Create_func_protobuf_update_repeated Create_func_protobuf_update_repeated::s_singleton;

Item*
Create_func_protobuf_update_repeated::create_native(THD *thd, LEX_STRING name,
                                           PT_item_list *item_list)
{
  Item* func= NULL;
  int arg_count= 0;
  ...
  {
    func= new (thd->mem_root) Item_func_protobuf_update_repeated(POS(), item_list);
  }
...
static Native_func_registry func_array[] =
{
  ...
  { { C_STRING_WITH_LEN("PROTOBUF_UPDATE_REPEATED") }, BUILDER(Create_func_protobuf_update_repeated)},
